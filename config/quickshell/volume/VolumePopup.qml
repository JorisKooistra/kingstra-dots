...
Item {
    ...
    readonly property int themedRadius: Math.max(10, ThemeConfig.styleWidgetRadius)
    readonly property int themedInnerRadius: Math.max(8, ThemeConfig.styleWidgetRadius - 4)
