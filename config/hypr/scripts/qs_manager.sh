...
if [[ "$ACTION" == "open" || "$ACTION" == "toggle" ]]; then
    ...
    SURFACE_NATIVE=" battery focustime network volume music calendar monitors performance gaming settings power notifications mail launcher clipboard windows "
