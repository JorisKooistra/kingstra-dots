...
QSGNode* BlobShape::updatePaintNode(QSGNode* oldNode, UpdatePaintNodeData*) {
    ...
    material->m_gradientStart = m_group->gradientStart();
    material->m_gradientMid = m_group->gradientMid();
    material->m_gradientEnd = m_group->gradientEnd();
    material->m_gradientDirX = static_cast<float>(m_group->gradientDirection().x());
    material->m_gradientDirY = static_cast<float>(m_group->gradientDirection().y());
    material->m_gradientOrigin = static_cast<float>(m_group->gradientOrigin());
    material->m_gradientSpan = static_cast<float>(m_group->gradientSpan());
    material->m_borderStart = m_group->borderStart();
    material->m_borderMid = m_group->borderMid();
    material->m_borderEnd = m_group->borderEnd();
